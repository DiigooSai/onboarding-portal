...
import { Building2, LayoutDashboard, FileText, Laptop, Package, MapPin, HelpCircle, Settings, LogOut } from "lucide-react";
...
export default function EmployeeSidebar() {
  ...
  const menuItems = [
    ...
    { id: "it-setup", label: "IT Setup", icon: Laptop, path: "/employee/it-setup" },
    { id: "assets", label: "Assets", icon: Package, path: "/employee/assets" },
    { id: "workspace", label: "Workspace", icon: MapPin, path: "/employee/workspace" },
  ];
